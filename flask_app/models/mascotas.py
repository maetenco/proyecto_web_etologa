...
class Mascota:
    ...
    def get_all_mascotas(cls):
        query = "SELECT mascotas.id, mascotas.nombre, mascotas.created_at, mascotas.updated_at, mascotas.tutor_id, mascotas.veterinario_id, tutores.nombre AS nombre_tutor, tutores.apellido AS apellido_tutor, antecedentes.dog_or_cat FROM mascotas JOIN tutores ON mascotas.tutor_id = tutores.id JOIN antecedentes ON mascotas.id = antecedentes.mascota_id"
